package com.example.petminder.ui.auth
...
import com.example.petminder.databinding.LoginBinding
import com.example.petminder.ui.home.Home
...
class Login : AppCompatActivity() {
    ...
    private fun createAccount(email: String, password: String) {
        ...
        loginRegisterViewModel.register(email.trim(), password.trim())
    }
    ...
    private fun signIn(email: String, password: String) {
        ...
        loginRegisterViewModel.login(email.trim(), password.trim())
    }
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                when(result.resultCode){
                    RESULT_OK -> {
                        ...
                        Timber.i("PetMinder Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
